...
Gem::Specification.new do |spec|
  ...
  spec.summary       = "An adapter code to use [spaCy](https://spacy.io/) NLP library from Ruby using PyCall."
  spec.description   = "An adapter code to use [spaCy](https://spacy.io/) NLP library from Ruby using PyCall."
